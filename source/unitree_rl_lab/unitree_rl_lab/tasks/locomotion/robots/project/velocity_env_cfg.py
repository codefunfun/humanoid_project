...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "slopes_down":      terrain_gen.HfPyramidSlopedTerrainCfg(proportion=0.2, 
                                                             slope_range=(0 , 0.436), # in radians = 25deg
                                                             platform_width=1,
                                                             inverted=True),
                                                             
        "stairs_up":      terrain_gen.HfPyramidStairsTerrainCfg(proportion=0.2,
                                                             step_height_range=(0,0.2), # in m
                                                             step_width=0.3, # in m
                                                             platform_width=1,
                                                             inverted=False),

        "stairs_down":      terrain_gen.HfPyramidStairsTerrainCfg(proportion=0.2,
                                                             step_height_range=(0,0.2), # in m
                                                             step_width=0.3, # in m
                                                             platform_width=1,
                                                             inverted=True)
        # "beam": 
        #"obstacles":   terrain_gen.HfDiscreteObstaclesTerrainCfg(proportion=0.15),
        #"stepping":    terrain_gen.HfSteppingStonesTerrainCfg(proportion=0.10),
    },
)
